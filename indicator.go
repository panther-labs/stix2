...
func (i *Indicator) AddIndicates(id Identifier, opts ...STIXOption) (*Relationship, error) {
	if !IsValidIdentifier(id) || !id.ForTypes(TypeAttackPattern, TypeCampaign, TypeInfrastructure,
		TypeIntrusionSet, TypeMalware, TypeThreatActor, TypeTool) {
		return nil, ErrInvalidParameter
	}
	return NewRelationship(RelationshipTypeIndicates, i.ID, id, opts...)
}
...
func (i *Indicator) AddBasedOn(id Identifier, opts ...STIXOption) (*Relationship, error) {
	if !IsValidIdentifier(id) || !id.ForType(TypeObservedData) {
		return nil, ErrInvalidParameter
	}
	return NewRelationship(RelationshipTypeBasedOn, i.ID, id, opts...)
}
