...
// AddDerivedFrom adds a relationship to an object that this object is derived
// from.
func (s *STIXCyberObservableObject) AddDerivedFrom(id Identifier, opts ...STIXOption) (*Relationship, error) {
	return NewRelationship(RelationshipTypeDerivedFrom, s.ID, id, opts...)
}

// AddDuplicateOf adds a relationship to an object that this object is a
// duplicate of.
func (s *STIXCyberObservableObject) AddDuplicateOf(id Identifier, opts ...STIXOption) (*Relationship, error) {
	return NewRelationship(RelationshipTypeDuplicateOf, s.ID, id, opts...)
}

// AddRelatedTo adds a relationship to an object that this object is related
// to.
func (s *STIXCyberObservableObject) AddRelatedTo(id Identifier, opts ...STIXOption) (*Relationship, error) {
	return NewRelationship(RelationshipTypeRelatedTo, s.ID, id, opts...)
}

// GetID returns the identifier for the object.
func (s *STIXCyberObservableObject) GetID() Identifier {
	return s.ID
}

// GetType returns the object's type.
func (s *STIXCyberObservableObject) GetType() STIXType {
	return s.Type
}

// GetCreated returns the created time for the STIX object. If the object
// does not have a time defined, nil is returned.
func (s *STIXCyberObservableObject) GetCreated() *time.Time {
	return nil
}

// GetModified returns the modified time for the STIX object. If the object
// does not have a time defined, nil is returned.
func (s *STIXCyberObservableObject) GetModified() *time.Time {
	return nil
}

func (s *STIXCyberObservableObject) canonicalizeExtensions() string {
	if len(s.Extensions) == 0 {
		return ""
	}
	buf := &bytes.Buffer{}
	//lint:ignore SA1019 this was used by original repo
	c := codec.NewEncoder(buf, &codec.JsonHandle{BasicHandle: codec.BasicHandle{EncodeOptions: codec.EncodeOptions{Canonical: true}}})
	err := c.Encode(s.Extensions)
	if err != nil {
		return ""
	}
	return buf.String()
