...
func (s *LanguageContent) MarshalJSON() ([]byte, error) {
	return marshalToJSONHelper(s)
}
...
func (s *LanguageContent) GetID() Identifier {
	return s.ID
}

// GetType returns the object's type.
func (s *LanguageContent) GetType() STIXType {
	return s.Type
}

// GetCreated returns the created time for the STIX object. If the object
// does not have a time defined, nil is returned.
func (s *LanguageContent) GetCreated() *time.Time {
	if s.Created == nil {
		return nil
	}
...
// does not have a time defined, nil is returned.
func (s *LanguageContent) GetModified() *time.Time {
	if s.Modified == nil {
		return nil
	}
...
func (m *MarkingDefinition) MarshalJSON() ([]byte, error) {
	return marshalToJSONHelper(m)
}

func (m *MarkingDefinition) addCustomProperties(c *CustomObject) {
	m.toplevelProperties = c
}

// GetExtendedTopLevelProperties returns the extra top level properties or
// nil for the object.
func (m *MarkingDefinition) GetExtendedTopLevelProperties() *CustomObject {
	return m.toplevelProperties
}
