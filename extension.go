...
func NewExtensionDefinition(name string, schema string, version string,
	extTypes []ExtensionType, opts ...STIXOption) (*ExtensionDefinition, error) {
	// Check the arguments
	if name == "" ||
		schema == "" ||
		version == "" ||
...
// nil for the object.
func (e *ExtensionDefinition) GetExtendedTopLevelProperties() *CustomObject {
	return nil
}
...
// GetExtendedTopLevelProperties returns the extra top level properties or
// nil for the object.
func (c *CustomObject) GetExtendedTopLevelProperties() *CustomObject {
	return nil
}
